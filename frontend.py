...
<body>
    ...
    <script>
        ...
        function applyFilters() {
            ...
            // ▼▼▼ CORREÇÃO APLICADA AQUI ▼▼▼
            // A linha que lia o valor do input de data foi removida.
            // ▼▼▼ FIM DA CORREÇÃO ▼▼▼
            ...
            if (mes) {
                ...
                // ▼▼▼ CORREÇÃO APLICADA AQUI ▼▼▼
                // A lógica que adicionava o 'data' foi removida.
                // Agora, se 'mes' não for selecionado, apenas o 'periodo' é considerado.
                // O backend usará a data atual como padrão.
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .log-financeiro-item { 
            display: grid; 
            grid-template-columns: 80px 60px 1fr 150px 100px 280px;
            align-items: start; 
            padding: 8px 0; 
...
def agendamentos_view(request):
    ...
    # ▼▼▼ CORREÇÃO APLICADA AQUI ▼▼▼
    # Gera uma lista de anos, do atual até 5 anos no futuro (2025 a 2030)
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            try:
                ...
                # Verifica se o erro específico de 'hora' está presente
                if 'hora' in error_details and isinstance(error_details['hora'], list):
                    # Se sim, usa apenas a mensagem de erro, sem o prefixo
                    messages.error(request, error_details['hora'][0])
                else:
                    # Para todos os outros erros, mantém o formato genérico
...
def informacoes_view(request):
    ...
    context = {
        ...
        'log_financeiro': [],
        # ▼▼▼ CORREÇÃO APLICADA AQUI ▼▼▼
        # Altera o range para gerar de 2025 a 2030
    ...
    try:
        ...
        # Requisição para auditoria financeira
