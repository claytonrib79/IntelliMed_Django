    ...
    <div class="main-content">
        ...
        <div class="backup-container">
            <div class="card">
                ...
                <p class="card-description">Escolha como deseja gerenciar seus backups. Os backups automáticos serão enviados para o e-mail cadastrado e realizados diariamente.</p>
                <form id="config-form" method="POST">
                    ...
                    <button type="submit" class="btn btn-save-config">Salvar Configuração</button>
                </form>
            </div>
            
            <div class="card">
                <h2 class="card-title">📥 Criar Backup Manual</h2>
                <p class="card-description">Gere e baixe um arquivo de segurança (.json) contendo todos os dados da sua clínica. Recomenda-se guardar este arquivo em um local seguro (ex: nuvem ou HD externo).</p>
                <button id="btn-download-backup" class="btn btn-download">Download do Backup Completo</button>
            </div>

            <div class="card restore-section">
                <h2 class="card-title">📤 Restaurar a partir de um Backup</h2>
                <p class="card-description">
                    <strong>⚠️ ATENÇÃO: AÇÃO IRREVERSÍVEL!</strong> Restaurar um backup irá <strong>APAGAR TODOS OS DADOS ATUAIS</strong> da sua clínica e substituí-los pelos dados do arquivo. Use com extrema cautela.
                </p>
                <form class="restore-form" method="POST" enctype="multipart/form-data" onsubmit="handleRestoreSubmit(event)">
                    ...
                    <button type="submit" class="btn btn-upload">Restaurar Dados</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        document.getElementById('btn-download-backup').addEventListener('click', async function() {
            ...
            try {
                ...
                if (!response.ok) {
                    throw new Error('Falha ao gerar o backup no servidor.');
                }
                ...
                this.textContent = 'Download do Backup Completo';
                this.disabled = false;
            }
        });
