...
def faturamento_view(request):
    ...
    # Ícone SVG de três pontos (substituição da engrenagem)
    icon_svg = """
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/>
    </svg>
...
def consultas_view(request):
    ...
    context = {
        ...
        'data': {}, 
        'error_message': None,
        'is_permission_error': False  # Novo contexto para controlar o tipo de erro
    }
    ...
    try:
        ...
        if e.response.status_code == 403:
            context['is_permission_error'] = True
            context['error_message'] = f"Seu perfil de '{user.get('funcao_display', 'usuário')}' não tem permissão para acessar o módulo de Consultas."
        else:
