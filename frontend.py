...
# ▼▼▼ SUBSTITUA A VARIÁVEL 'PACIENTE_EXAMES_TEMPLATE' INTEIRA POR ESTA VERSÃO CORRIGIDA ▼▼▼
                    ...
                    {% for exame in exames_ia %}
                        <div class="exame-item">
                            <div class="exame-info">
                                ...
                                <div class="exame-actions">
                                    <!-- ▼▼▼ LINK ALTERADO PARA PASSAR O ID DO PACIENTE ▼▼▼ -->
                    ...
                    {% for exame in exames_gerais %}
                        <div class="exame-item">
                            <div class="exame-info">
                                ...
                                <div class="exame-actions">
                                    <a href="{% url 'exame_geral_visualizar' paciente_id=paciente.id exame_id=exame.id %}" class="action-link">🖨️ Ver/Imprimir</a>
                                </div>
                            </div>
                        </div>
                    {% empty %}
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card"><h3>Receitas Vencidas</h3><div class="amount text-danger">R$ {{ dashboard_data.receitas.vencidas|default:'0,00' }}</div></div>
            ...
            <div class="stat-card"><h3>Despesas a Pagar</h3><div class="amount text-warning">R$ {{ dashboard_data.despesas.a_pagar|default:'0,00' }}</div></div>
            ...
            <div class="stat-card card-lucro">
                ...
                {% if dashboard_data.lucro_liquido >= 0 %}
                    <div class="amount text-success" id="lucro-liquido">R$ 0,00</div>
                {% else %}
                    <div class="amount text-danger" id="lucro-liquido">R$ 0,00</div>
                {% endif %}
            </div>
            ...
            <div class="stat-card card-receitas">
                ...
                {% if dashboard_data.previsao_mensal >= 0 %}
                    <div class="amount text-success" id="previsao-mensal">R$ 0,00</div>
                {% else %}
                    <div class="amount text-danger" id="previsao-mensal">R$ 0,00</div>
                {% endif %}
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Lógica para formatar o Lucro Líquido
            const lucroEl = document.getElementById('lucro-liquido');
            if (lucroEl) {
                const lucroValue = parseFloat({{ dashboard_data.lucro_liquido|default:0 }});
                lucroEl.textContent = 'R$ ' + lucroValue.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
            }

            // Lógica para formatar a Previsão Mensal
            const previsaoEl = document.getElementById('previsao-mensal');
            if (previsaoEl) {
                const previsaoValue = parseFloat({{ dashboard_data.previsao_mensal|default:0 }});
                previsaoEl.textContent = 'R$ ' + previsaoValue.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
            }
        ...
        function updateLancamentoStatus(tipo, id, selectElement) {
            ...
            if (novoStatus === 'paga' || novoStatus === 'recebida') {
                const dateField = tipo === 'receita' ? 'data_recebimento' : 'data_pagamento';
                payload[dateField] = new Date().toISOString().slice(0, 10);
            }
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            ...
            <form method="POST">
                ...
                <!-- CAMPOS DE STATUS E DATA DE PAGAMENTO/RECEBIMENTO ADICIONADOS -->
                <div class="form-grid">
                    <div class="form-group">
                    ...
                    <div class="form-group" id="data-pagamento-group" style="display: none;">
                        {% if tipo_lancamento == 'receita' %}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Executa na carga da página e quando o status muda
            toggleDataPagamento();
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ▼▼▼ NOVOS ESTILOS PARA OS CARDS DE HISTÓRICO ▼▼▼ */
    ...
    <div class="main-content">
        ...
        {% else %}
            <div class="info-container">
                ...
                <!-- ▼▼▼ NOVOS CARDS DE HISTÓRICO ADICIONADOS AQUI ▼▼▼ -->
...
<body>
    ...
    <div class="main-content">
        ...
        <!-- ▼▼▼ LÓGICA DE EXIBIÇÃO DE ERRO ATUALIZADA ▼▼▼ -->
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            window.printDocument = function(tipo) {
                ...
                if (printWindow) {
                    ...
                    printWindow.document.write('<style>body { font-family: "Courier New", monospace; white-space: pre-wrap; margin: 20px; }</style>');
                    ...
                    // Listener para fechar a janela após a impressão
                    ...
                    alert('Por favor, habilite pop-ups para este site para poder imprimir.');
                }
            }
        });
    </script>
...
def faturamento_view(request):
    ...
    try:
        ...
        if dash_response.status_code == 200:
            ...
            dashboard_data = {
                ...
                'previsao_mensal': dashboard_data_raw.get('previsao_mensal', 0) # NOVO CAMPO ADICIONADO
            }
    ...
    for r in receitas:
        ...
        <tr>
            <td>{r['descricao']}</td>
            <td class="truncate-text text-success">R$ {format_currency_brl(r['valor'])}</td>
    ...
    for d in despesas:
        ...
        <tr>
            <td>{d['descricao']}</td>
            <td class="truncate-text text-danger">R$ {format_currency_brl(d['valor'])}</td>
...
def informacoes_view(request):
    ...
    try:
        ...
        # ▼▼▼ NOVA REQUISIÇÃO PARA O HISTÓRICO DE AUDITORIA ▼▼▼
